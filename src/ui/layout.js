...
import { closeMobilePanel, openMobilePanel } from './mobile.js';
...
/**
 * Apply panel position (left/right).
 */
export function applyPanelPosition() {
    ...
    $panel.addClass(`dnd-position-${extensionSettings.panelPosition || 'right'}`);
